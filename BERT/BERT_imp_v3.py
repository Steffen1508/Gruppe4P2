...
label_map = {
    ...
    # FULL_NAME bruges når hele navnet optræder samlet ("Jonas Hansen")
    # FIRST_NAME og LAST_NAME bruges når de optræder separat i datasættet
    "FULL_NAME": 11,
    "FIRST_NAME": 12,
    "LAST_NAME": 13,
    "EMAIL": 14,
...
class BertTrainer:
    ...
    def __init__(self, model_name: str = "bert-base-uncased"):
        ...
        class_weights[label_map["O"]]              = 0.3   # Lidt dæmpet
        class_weights[label_map["ROUTING_NUMBER"]] = 2.0
        class_weights[label_map["COORDINATES"]]    = 2.0
        class_weights[label_map["PASSPORT_NUMBER"]]= 1.5
        class_weights[label_map["COMPANY"]]        = 1.5
...
Test:       39900 eksempler
  Evaluerer: 100%|█████████▉| 414/416 [02:14<00:00,  3.05bEpoch 1/5  |  Train loss: 0.3383  |  Val loss: 0.0794  |  Val accuracy: 0.9703
Writing model shards: 100%|██████████| 1/1 [00:00<00:00,  1.26it/s]
Model gemt til: saved_model
  Ny bedste model gemt (val loss: 0.0794)
  EvaluereEpoch 2/5  |  Train loss: 0.0690  |  Val loss: 0.0633  |  Val accuracy: 0.9777
Writing model shards: 100%|██████████| 1/1 [00:00<00:00,  1.30it/s]
Model gemt til: saved_model
  Ny bedste model gemt (val loss: 0.0633)
  EvaluereEpoch 3/5  |  Train loss: 0.0522  |  Val loss: 0.0599  |  Val accuracy: 0.9772
Writing model shards: 100%|██████████| 1/1 [00:01<00:00,  1.16s/it]
Model gemt til: saved_model
  Ny bedste model gemt (val loss: 0.0599)
  EvaluereEpoch 4/5  |  Train loss: 0.0427  |  Val loss: 0.0597  |  Val accuracy: 0.9801
Writing model shards: 100%|██████████| 1/1 [00:00<00:00,  1.24it/s]
Model gemt til: saved_model
  Ny bedste model gemt (val loss: 0.0597)
  EvaluereEpoch 5/5  |  Train loss: 0.0367  |  Val loss: 0.0598  |  Val accuracy: 0.9806
  Val loss steg – stopper tidligt efter epoch 5
  Indlæser bedste model fra epoch 4 (val loss: 0.0597)
Loading weights: 100%|██████████| 199/199 [00:00<00:00, 5283.07it/s]
Model indlæst fra: saved_model
